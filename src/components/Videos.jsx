    ...
    <Stack direction={['column', 'row']} h="100vh">
        <VStack w={"full"}>
            ...
            <VStack alignItems={"flex-start" } p="8" w={"full"} overflowY={"auto"}>
                <Heading>Smple video is</Heading>
                <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae error perspiciatis ex mollitia, harum unde, minima tempore distinctio officiis non perferendis sed. Excepturi ut eos esse magni soluta tenetur ex? Dolores esse expedita iste? Dolorum porro placeat sequi molestiae debitis.</Text>
            </VStack>
        </VStack>
